...
// Cuerpo Shadertoy verbatim. Turbulencia por modulación de frecuencia: ondas
// triangulares (`tri`) moduladas en frecuencia (`fm`), iteradas con una rotación
// del ángulo áureo y coloreadas con un kernel 1/(x²+k). Usa `round()` → GLSL3.
const body = /* glsl */ `
