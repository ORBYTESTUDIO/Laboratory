...
// Cuerpo Shadertoy verbatim — "Nebula flight" de Orblivius. Túnel de estrellas
// procedural (GetParticlePos/GetParticleColour) sobre ray-marching de nubes
// intergalácticas (SpiralNoise + cloud map, color HSV por densidad). Usa
// `tanh()` y bucles con break → GLSL3. Sin texturas; iMouse orienta la vista.
const body = /* glsl */ `
