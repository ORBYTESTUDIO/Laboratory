import { wrapShadertoy } from '../_shared/shadertoy';

// Cuerpo Shadertoy verbatim. Ray-marching de un tubo deformado por FBM (Map),
// con planetas intersectados analíticamente, nebulosa de fondo, sol y lens-flare.
// Canales: iChannel0 = ruido (FBM), iChannel1 = fondo, iChannel2 = planetas,
// iChannel3 = FFT de audio (acá sintético). Usa texture()/textureLod() → GLSL3.
const body = /* glsl */ `
...
export const fragmentShader = wrapShadertoy(body, [
  'iChannel0',
  'iChannel1',
  'iChannel2',
  'iChannel3',
